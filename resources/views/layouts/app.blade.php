                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link px-md-4 text-dark" href="{{ route('login') }}">{{ __('Login') }}</a>
                                </li>
                            @endif
                            
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link px-md-4 text-dark" href="{{ route('register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link px-md-4 text-dark dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
...
<footer class="p-3 bg-dark text-white text-center mt-5">
    Copyright &copy;2021 RestHotel - All Rights Reserved
</footer>
